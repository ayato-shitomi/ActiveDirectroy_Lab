...
# TODO: nakanishi credential cache - temporarily disabled for debugging
Write-Host "nakanishi credential cache disabled - ensuring CheckEventNumber works first"
