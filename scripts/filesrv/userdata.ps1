...
# TODO: Create credential cache for nakanishi (temporarily disabled due to domain join timing)
Write-Host "Credential cache creation temporarily disabled - will be re-enabled after domain join stabilizes"
